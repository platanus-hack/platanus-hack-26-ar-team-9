...
Para correr:  pytest pipeline/tests/test_scraper_client.py
"""
...
from scraper_client import EPOCH_CURSOR, pull_all  # noqa: E402
...
def test_normalize_row_maps_all_fields():
    ...
    from scraper_client import _normalize_row
